...
class $InAppMessageSeenDatesTable extends i2.InAppMessageSeenDates
  ...
  @override
  List<i0.GeneratedColumn> get $columns => [id, message, seen];
  @override
...
class InAppMessageSeenDate extends i0.DataClass
  ...
  const InAppMessageSeenDate(
      {required this.id, required this.message, required this.seen});
  @override
  ...
  i1.InAppMessageSeenDate copyWith(
          {int? id, String? message, DateTime? seen}) =>
  ...
  @override
  int get hashCode => Object.hash(id, message, seen);
  @override
